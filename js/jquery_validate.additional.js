...
jQuery.validator.addMethod("permalink", function(value, element) {
...
}, "Only letters, numbers,slash, and dash");
...
/**
  * Added this method for system performance
  */
jQuery.validator.addMethod('icPisValid',function(value,element,params) {
    x = false;
    jQuery.ajax({
        url   : params.url,
        type  : 'post',
        ...
        success : function(result) {
            x = $.trim(result) === 'true' ? true : false;
        }
    });  
    return x;  
},'Ups, you entered invalid data. Please try again :(');

jQuery.extend(jQuery.validator.messages, {
    min : jQuery.validator.format('Minimum value {0}'),
    max : jQuery.validator.format('Maximum value {0}')
});